		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<form id="newpost" enctype="multipart/form-data" method="put" action="entradas.php">
						<div class="row">
								...
								<div class="card">
									...
									<div class="card-body">
										<label class="custom-control custom-checkbox">
								          <input type="checkbox" name="category[noticias]" class="custom-control-input">
								          <span class="custom-control-label">Noticias</span>
								        </label>
										<label class="custom-control custom-checkbox">
								          <input type="checkbox" name="category[vida]" class="custom-control-input" checked="">
								          <span class="custom-control-label">Vida</span>
								        </label>
										<label class="custom-control custom-checkbox">
								          <input type="checkbox" name="category[raices]" class="custom-control-input">
								          <span class="custom-control-label">Raices</span>
								        </label>
									</div>
								</div>
								<div class="card">
									...
									<div class="card-body">
										<div>
										<select class="form-control select2" name="tag[]" data-toggle="select2" multiple="">
